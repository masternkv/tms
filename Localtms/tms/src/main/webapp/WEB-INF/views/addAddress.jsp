...
<ul class="nav nav-tabs">
 ...
 <div id="menu1" class="tab-pane fade">
    ...
    <td>${schoolAddress[0].addressLane1},${schoolAddress[0].addressLane2},${schoolAddress[0].stateDetails.state_Name},
        ${schoolAddress[0].countryDetails.counrtyName},${schoolAddress[0].addressZip}
     </td>
